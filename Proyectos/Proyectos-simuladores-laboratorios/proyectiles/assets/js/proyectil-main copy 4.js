 ...
 * Nivel 5: Eliminación del fondo sólido del canvas para mostrar GIF.
 */
...
function drawGround(camera) {
  ...
  if (groundPattern) {
    ...
    // Dibuja el suelo con su patrón, extendiéndolo para compensar el scroll de la cámara.
    ctx.fillRect(
      0,
      groundCanvasY,
      canvas.width,
...
function draw() {
  // ¡NUEVO! Ya no borramos ni rellenamos el canvas con un color sólido aquí.
  // El GIF de fondo se verá a través de la transparencia del canvas.
